...
We created the survey by directly converting key research question to a survey question designed to elicit the required answers where able. 

Furthermore, we did not require any questions to submit the survey because we felt it was important to ensure reliable answers and wanted to ensure the highest possible response rate. We provided context of our project before asking the following questions.
...
\textbf{Key Research Question:} How do students currently keep track of grades?
\smallskip

\textbf{Survey Question:} What tools do you use to keep track of grades?
\smallskip
...
\textbf{Key Research Question:} How comfortable are students with sharing their grades?
\smallskip

\textbf{Survey Question:} Have you ever shared your overall course or individual assessment grades in slack?
\smallskip
...
\textbf{Survey Question:} How comfortable are you with sharing grades with other students?
\smallskip
...
\textbf{Survey Question:} What would make you more comfortable sharing grades?
\smallskip
...
\textbf{Key Research Question:} How honest will people be with reporting their grades, anonymously or not?
\smallskip

\textbf{Survey Question:} How would you feel about submitting a low grade anonymously?
\smallskip

\textbf{Results:} 73.7\% reported indifferent and 26.3\% reported good
\smallskip

\textbf{Survey Question:} How would you feel about submitting a low grade publicly?
\smallskip

\textbf{Results:} 78.9\% reported bad and 21.1\% reported indifferent

\textbf{Key Research Question:} Why would students want to compare their grades with other students?
\smallskip

\textbf{Survey Question:} Please rate to what degree each of the following are important reasons for contributing grades? 1 is not important, 5 is very important
\begin{itemize}
...
\textbf{Key Research Question:} Why would students want to see retrospective tips left by other students?
\smallskip

\textbf{Survey Question:} Please rate to what degree each of the following are important reasons for leaving retrospective tips for courses? 1 is not important, 5 is very important
\begin{itemize}
